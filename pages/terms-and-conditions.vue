<script setup>
const date = '2023/09/17 19:00';
const lastModified = ref(null);

onMounted(() => {
  lastModified.value = new Date(date).toLocaleString();
})
</script>
  ...
  <section class="uk-section uk-section-muted uk-section-small">
    <div class="uk-container uk-container-small">
      ...
      <div class="uk-text-center">
        <h1 class="uk-text-bold uk-margin-remove-top">{{ $t("section.terms_and_conditions.title") }}</h1>
        <p class="uk-margin-large-bottom">{{ $t("section.terms_and_conditions.text", { date: lastModified }) }}</p>
      </div>

      <p>We are Vultive (&quot;<b>Company</b>,&quot; &quot;<b>we</b>,&quot; &quot;<b>us</b>,&quot;
        &quot;<b>our</b>&quot;). We operate the website vultive.com (the &quot;<b>Site</b>&quot;), as well as any other related products and
        services that refer or link to these legal terms (the &quot;<b>Legal Terms</b>&quot;) (collectively, the
        &quot;<b>Services</b>&quot;).</p>
      <p>You can contact us by email at <a href="mailto:support@vultive.com" class="uk-link-text">support@vultive.com</a>.</p>
      <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of
        an entity (&quot;<b>you</b>&quot;), and Vultive, concerning your access to and use of the Services. You agree
      ...
      <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified
        Legal Terms will become effective upon posting or notifying you by <a href="mailto:privacy@vultive.com" class="uk-link-text">privacy@vultive.com</a>m, as stated in the email
        message. By continuing to use the Services after the effective date of any changes, you agree to be bound by
        the modified terms.</p>
      <p>The Services are intended for users who are at least 18 years old. Persons under the age of 18 are not
        permitted to use or register for the Services.</p>
      ...
      <p><b>2. INTELLECTUAL PROPERTY RIGHTS</b></p>
      ...
      <p>We are the owner or the licensee of all intellectual property rights in our Services, including all source
        ...
        contained therein (the &quot;Marks&quot;).</p>
      <p>Our Content and Marks are protected by copyright and trademark laws (and various other intellectual property
        rights and unfair competition laws) and treaties in the United States and around the world.</p>
      ...
      <p>Subject to your compliance with these Legal Terms, including the &quot;PROHIBITED ACTIVITIES&quot; section
        below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
      <p>&#57355; access the Services; and&#57355; download or print a copy of any portion of the Content to which you
        have properly </p>
      <p>gained access.solely for your personal, non-commercial use.</p>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or
        elsewhere in our Legal Terms, please address your request to: <a href="mailto:privacy@vultive.com" class="uk-link-text">privacy@vultive.com</a>. If we ever grant you the
        ...
        notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
      <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and
        your right to use our Services will terminate immediately.</p>
      <p><b>Your submissions and contributions</b></p>
      <p>Please review this section and the &quot;PROHIBITED ACTIVITIES&quot; section carefully prior to using our
      ...
      <p><b>Submissions: </b>By directly sending us any question, comment, suggestion, idea, feedback, or other
        information about the Services (&quot;Submissions&quot;), you agree to assign to us all intellectual property
        rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use
        and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to
        you.</p>
      <p><b>Contributions: </b>The Services may invite you to chat, contribute to, or participate in blogs, message
        boards, online forums, and other functionality during which you may create, submit, post, display, transmit,
        publish, distribute, or broadcast content and materials to us or through the Services, including but not
        limited to text, writings, video, audio, photographs, music, graphics, comments, reviews, rating suggestions,
        personal information, or other material (&quot;Contributions&quot;). Any Submission that is publicly posted
        shall also be treated as a Contribution.</p>
      <p>You understand that Contributions may be viewable by other users of the Services and possibly through
        third-party websites.</p>
      <p><b>When you post Contributions, you grant us a license (including use of your name, trademarks, and logos):
        </b>By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual,
        ...
        of, or incorporate into other works, your Contributions, and to sublicense the licenses granted in this
        section. Our use and distribution may occur in any media formats and through any media channels.</p>
      ...
      <p><b>You are responsible for what you post or upload: </b>By sending us Submissions and/or posting
        Contributions through any part of the Services or making Contributions accessible </p>
      <p>through the Services by linking your account through the Services to any of your social networking accounts,
        you:</p>
      <p>&#57355; confirm that you have read and agree with our &quot;PROHIBITED ACTIVITIES&quot; and will not post,
        send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is
        illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to
        any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</p>
      <p>&#57355; to the extent permissible by applicable law, waive any and all moral rights to any such Submission
        and/or Contribution;</p>
      <p>&#57355; warrant that any such Submission and/or Contributions are original to you or that you have the
        necessary rights and licenses to submit such Submissions and/or Contributions and that you have full authority
        to grant us the above-mentioned rights in relation to your Submissions and/or Contributions; and</p>
      <p>&#57355; warrant and represent that your Submissions and/or Contributions do not constitute confidential
        information.</p>
      <p>You are solely responsible for your Submissions and/or Contributions and you expressly agree to reimburse us
      ...
      <p><b>We may remove or edit your Content: </b>Although we have no obligation to monitor any Contributions, we
        ...
        such Contributions, we may also suspend or disable your account and report you to the authorities.</p>
      ...
      <p>We respect the intellectual property rights of others. If you believe that any material available on or
        ...
        &quot;COPYRIGHT INFRINGEMENTS&quot; section below.</p>
      <p><b>3. USER REPRESENTATIONS</b></p>
      <p>By using the Services, you represent and warrant that: (1) all registration information you submit will be
        ...
        with these Legal Terms; (4) you are not under the age of 13; (5) you are not a minor in the jurisdiction in
        which you reside, or if a minor, you have received parental permission to use the Services; (6) you will not
        access the Services through automated or non-human means, whether through a bot, script or otherwise; (7) you
        will not </p>
      <p>use the Services for any illegal or unauthorized purpose; and (8) your use of the Services will not violate
      ...
      <p><b>6. PURCHASES AND PAYMENT</b></p>
      ...
      <p>You agree to provide current, complete, and accurate purchase and account information for all purchases made
        ...
        change prices at any time. All payments shall be in Euros.</p>
      <p>You agree to pay all charges at the prices then in effect for your purchases and any applicable shipping
        ...
        order. If your order is subject to recurring charges, then you consent to our charging your payment method on
        ...
        have already requested or received payment.</p>
      <p>We reserve the right to refuse any order placed through the Services. We may, in our sole discretion, limit
      ...
      <p><b>7. REFUNDS POLICY</b></p>
      <p>All sales are final and no refund will be issued.</p>
      <p><b>8. SOFTWARE</b></p>
      <p>We may include software for use in connection with our Services. If such software is accompanied by an end
        user license agreement (&quot;EULA&quot;), the terms of the EULA will govern your use of the software. If such
        ...
        these Legal Terms. Any software and any related documentation is provided &quot;AS IS&quot; without warranty
        of any kind, either express or implied, including, without limitation, the implied warranties of
        merchantability, fitness for a particular purpose, or non-infringement. You accept any and all risk arising
        out of use or performance of any software. You may not reproduce or redistribute any software except in
        accordance with the EULA or these Legal Terms.</p>
      <p><b>9. PROHIBITED ACTIVITIES</b></p>
      ...
      <p>As a user of the Services, you agree not to:&#57355; Systematically retrieve data or other content from the
        Services to create or compile, directly </p>
      <p>or indirectly, a collection, compilation, database, or directory without written permission from us.</p>
      ...
      <p>&#57355; Circumvent, disable, or otherwise interfere with security-related features of the Services,
        including features that prevent or restrict the use or copying of any Content or enforce limitations on the
        use of the Services and/or the Content contained therein.</p>
      <p>&#57355; Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Services.</p>
      <p>&#57355; Use any information obtained from the Services in order to harass, abuse, or harm another person.
      </p>
      <p>&#57355; Make improper use of our support services or submit false reports of abuse or misconduct.&#57355;
        Use the Services in a manner inconsistent with any applicable laws or regulations.&#57355; Engage in
        unauthorized framing of or linking to the Services.&#57355; Upload or transmit (or attempt to upload or to
        transmit) viruses, Trojan horses, or other </p>
      <p>material, including excessive use of capital letters and spamming (continuous posting of repetitive text),
        that interferes with any party&#8217;s uninterrupted use and enjoyment of the Services or modifies, impairs,
        disrupts, alters, or interferes with the use, features, functions, operation, or maintenance of the Services.
      </p>
      <p>&#57355; Engage in any automated use of the system, such as using scripts to send comments or messages, or
        using any data mining, robots, or similar data gathering and extraction tools.</p>
      <p>&#57355; Delete the copyright or other proprietary rights notice from any Content.&#57355; Attempt to
        impersonate another user or person or use the username of another user.&#57355; Upload or transmit (or attempt
        to upload or to transmit) any material that acts as a passive </p>
      <p>or active information collection or transmission mechanism, including without limitation, clear graphics
        ...
        &quot;pcms&quot;).</p>
      <p>&#57355; Interfere with, disrupt, or create an undue burden on the Services or the networks or services
        connected to the Services.</p>
      <p>&#57355; Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any
        portion of the Services to you.</p>
      <p>&#57355; Attempt to bypass any measures of the Services designed to prevent or restrict access to the
        Services, or any portion of the Services.</p>
      <p>&#57355; Copy or adapt the Services' software, including but not limited to Flash, PHP, HTML, JavaScript, or
        other code.</p>
      <p>&#57355; Except as permitted by applicable law, decipher, decompile, disassemble, or reverse engineer any of
        the software comprising or in any way making up a part of the Services.</p>
      <p>&#57355; Except as may be the result of standard search engine or Internet browser usage, use, launch,
        ...
        software.</p>
      <p>&#57355; Use a buying agent or purchasing agent to make purchases on the Services.&#57355; Make any
        unauthorized use of the Services, including collecting usernames and/or email </p>
      <p>addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating
        user accounts by automated means or under false pretenses.</p>
      <p>&#57355; Use the Services as part of any effort to compete with us or otherwise use the Services and/or the
        Content for any revenue-generating endeavor or commercial enterprise.</p>
      <p>&#57355; Sell or otherwise transfer your profile.</p>
      <p><b>10. USER GENERATED CONTRIBUTIONS</b></p>
      <p>The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums,
      ...
      <p>&#57355; The creation, distribution, transmission, public display, or performance, and the accessing,
        downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including
        but not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.</p>
      <p>&#57355; You are the creator and owner of or have the necessary licenses, rights, consents, releases, and
        permissions to use and to authorize us, the Services, and other users of the Services to use your
        Contributions in any manner contemplated by the Services and these Legal Terms.</p>
      <p>&#57355; You have the written consent, release, and/or permission of each and every identifiable individual
        person in your Contributions to use the name or likeness of each and every such identifiable individual person
        to enable inclusion and use of your Contributions in any manner contemplated by the Services and these Legal
        Terms.</p>
      <p>&#57355; Your Contributions are not false, inaccurate, or misleading.&#57355; Your Contributions are not
        unsolicited or unauthorized advertising, promotional </p>
      <p>materials, pyramid schemes, chain letters, spam, mass mailings, or other forms of solicitation.</p>
      <p>&#57355; Your Contributions are not obscene, lewd, lascivious, filthy, violent, harassing, libelous,
        slanderous, or otherwise objectionable (as determined by us).</p>
      <p>&#57355; Your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.&#57355; Your
        Contributions are not used to harass or threaten (in the legal sense of those </p>
      <p>terms) any other person and to promote violence against a specific person or class of people.</p>
      <p>&#57355; Your Contributions do not violate any applicable law, regulation, or rule.&#57355; Your
        Contributions do not violate the privacy or publicity rights of any third party.&#57355; Your Contributions do
        not violate any applicable law concerning child pornography, or </p>
      <p>otherwise intended to protect the health or well-being of minors.&#57355; Your Contributions do not include
        any offensive comments that are connected to race, </p>
      <p>national origin, gender, sexual preference, or physical handicap.&#57355; Your Contributions do not otherwise
        violate, or link to material that violates, any </p>
      <p>provision of these Legal Terms, or any applicable law or regulation.</p>
      <p>Any use of the Services in violation of the foregoing violates these Legal Terms and may result in, among
        other things, termination or suspension of your rights to use the Services.</p>
      <p><b>11. CONTRIBUTION LICENSE</b></p>
      <p>By posting your Contributions to any part of the Services or making Contributions accessible to the Services
        ...
        grant and authorize sublicenses of the foregoing. The use and distribution may occur in any media formats and
        through any media channels.</p>
      <p>This license will apply to any form, media, or technology now known or hereafter developed, and includes our
      ...
      <p><b>12. GUIDELINES FOR REVIEWS</b></p>
      <p>We may provide you areas on the Services to leave reviews or ratings. When posting a review, you must comply
        ...
        origin, age, marital status, </p>
      <p>sexual orientation, or disability; (4) your reviews should not contain references to illegal activity; (5)
        you should not be affiliated with competitors if posting negative reviews; (6) you should not make any
        conclusions as to the legality of conduct; (7) you may not post any false or misleading statements; and (8)
        you may not organize a campaign encouraging others to post reviews, whether positive or negative.</p>
      <p>We may accept, reject, or remove reviews in our sole discretion. We have absolutely no obligation to screen
        ...
        means, display, perform, and/or distribute all content relating to review.</p>
      <p><b>13. SOCIAL MEDIA</b></p>
      <p>As part of the functionality of the Services, you may link your account with online accounts you have with
        ...
        terms and conditions that govern your use of the applicable Third-Party Account, and without obligating us to
        pay any fees or making us subject to any usage limitations imposed by the third-party service provider of the
        Third-Party Account. By granting us access to any Third-Party Accounts, you understand that (1) we may access,
        make available, and store (if applicable) any content that you have provided to and stored in your Third-Party
        Account (the &quot;Social Network Content&quot;) so that it is available on and through the Services via your
        ...
        Third-Party Account. Depending on the Third-Party Accounts you choose and subject to the privacy settings that
        you have set in such Third-Party Accounts, personally identifiable information that you post to your
        Third-Party Accounts may be available on and through your account on the Services. Please note that if a
        ...
        and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE
        PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED </p>
      <p>SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any Social
        ...
        registered to use the Services. You can deactivate the connection between the Services and your Third-Party
        Account by contacting us using the contact information below or through your account settings (if applicable).
        We will attempt to delete any information stored on our servers that was obtained through such Third-Party
        Account, except the username and profile picture that become associated with your account.</p>
      <p><b>14. THIRD-PARTY WEBSITES AND CONTENT</b></p>
      <p>The Services may contain (or you may be sent via the Site) links to other websites (&quot;Third-Party
        ...
        be aware these Legal Terms no longer govern. You should review the applicable terms and policies, including
        privacy and data gathering practices, of any website to which you navigate from the Services or relating to
        any applications you use or install from the Services. Any purchases you make through Third-Party Websites
        will be through other websites and from other companies, and we take no responsibility whatsoever in relation
        to such purchases which are exclusively between you and the applicable third party. You agree and acknowledge
      ...
      <p><b>15. ADVERTISERS</b></p>
      <p>We allow advertisers to display their advertisements and other information in certain areas of the Services,
        such as sidebar advertisements or banner advertisements. We simply provide the space to place such
        advertisements, and we have no other relationship with advertisers.</p>
      <p><b>16. SERVICES MANAGEMENT</b></p>
      ...
      <p>We care about data privacy and security. Please review our Privacy Policy:
        <b><a href="https://vultive.com/#company" class="uk-link-text">https://vultive.com/#company</a></b>. By using the Services, you agree to be bound by our Privacy Policy, which
        is incorporated into these Legal Terms. Please be advised the Services are hosted in Poland and France. If you
        access the Services from any other region of the world with laws or other requirements governing personal data
        collection, use, or disclosure that differ from applicable laws in Poland and France, then through your
        continued use of the Services, you are transferring your data to Poland and France, and you expressly consent
        to have your data transferred to and processed in Poland and France. Further, we do not knowingly accept,
        request, or solicit information from children or knowingly market to children. Therefore, in accordance with
        the U.S. Children&#8217;s Online Privacy Protection Act, if we receive actual knowledge that anyone under the
      ...
      <p><b>18. COPYRIGHT INFRINGEMENTS</b></p>
      <p>We respect the intellectual property rights of others. If you believe that any material available on or
        ...
        Thus, if you are not sure </p>
      <p>that material located on or linked to by the Services infringes your copyright, you should consider first
        contacting an attorney.</p>
      <p><b>19. TERM AND TERMINATION</b></p>
      <p>These Legal Terms shall remain in full force and effect while you use the Services. WITHOUT LIMITING ANY
      ...
      <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating a
        ...
        redress.</p>
      <p><b>20. MODIFICATIONS AND INTERRUPTIONS</b></p>
      ...
      <p>These Legal Terms are governed by and interpreted following the laws of Poland, and the use of the United
        ...
        obligatory provisions of the law in your country to residence. Vultive and yourself both agree to submit to
        the non-exclusive jurisdiction of the courts of __________, which means that you may make a claim to defend
        your consumer protection rights in regards to these Legal Terms in Poland, or in the EU country in which you
        reside.</p>
      <p><b>22. DISPUTE RESOLUTION</b></p>
      <p><b>Binding Arbitration</b></p>
      <p>Any dispute arising from the relationships between the Parties to these Legal Terms shall be determined by
        one arbitrator who will be chosen in accordance with the Arbitration and Internal Rules of the European Court
        of Arbitration being part of the European Centre of Arbitration having its seat in Strasbourg, and which are
        in force at the time the application for arbitration is filed, and of which adoption of this clause
        constitutes acceptance. The seat of arbitration shall be Poland. The language of the proceedings shall be
        English. Applicable rules of substantive law shall be the law of Poland.</p>
      ...
      <p>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SERVICES WILL BE
        ...
        APPROPRIATE.</p>
      <p><b>25. LIMITATIONS OF LIABILITY</b></p>
      <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY
        ...
        LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION
        ARISING. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE
        EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS
        OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.</p>
      <p><b>26. INDEMNIFICATION</b></p>
      <p>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our
        ...
        other user of the Services with whom you connected via the Services. Notwithstanding the foregoing, we reserve
      ...
      <p><b>28. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</b></p>
      ...
      <p><b>29. CALIFORNIA USERS AND RESIDENTS</b></p>
      ...
      <p><b>31. CONTACT US</b></p>
      <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the
        Services, please contact us at email: <a href="mailto:privacy@vultive.com" class="uk-link-text">privacy@vultive.com</a></p>
